        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SapCode = table.Column<string>(maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountExecutiveId = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Stores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Stores_AspNetUsers_AccountExecutiveId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountExecutiveId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportRequests_AspNetUsers_AccountExecutiveId",
                        column: x => x.AccountExecutiveId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportRequests_AspNetUsers_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SupportRequests_Stores_StoreId",
                        column: x => x.StoreId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeneratedDocuments_SupportRequests_SupportRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StateChanges_SupportRequests_SupportRequestId",
                        column: x => x.SupportRequestId,
                        principalTable: "SupportRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StateChanges_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestedSupport = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    RequestedValue = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    ApprovedSupport = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    ApprovedValue = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    UsedSupport = table.Column<decimal>(type: "decimal(18, 2)", nullable: false),
                    UsedValue = table.Column<decimal>(type: "decimal(18, 2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportResultLineItems", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneratedDocuments_SupportRequestId",
                table: "GeneratedDocuments",
                column: "SupportRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_StateChanges_SupportRequestId",
                table: "StateChanges",
                column: "SupportRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_StateChanges_UserId",
                table: "StateChanges",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Stores_AccountExecutiveId",
                table: "Stores",
                column: "AccountExecutiveId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportRequests_AccountExecutiveId",
                table: "SupportRequests",
                column: "AccountExecutiveId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportRequests_ManagerId",
                table: "SupportRequests",
                column: "ManagerId");

            migrationBuilder.CreateIndex(
                name: "IX_SupportRequests_StoreId",
                table: "SupportRequests",
                column: "StoreId");
